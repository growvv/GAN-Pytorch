...
class UpsampleBlock(nn.Module):
    def __init__(self, in_channels, scale_factor):
        ...
        self.ps = nn.PixelShuffle(scale_factor)  # in_c*4, H, W -> inc, H*2, W*2
...
class Generator(nn.Module):
    def __init__(self, in_channels=3, num_channels=64, num_blocks=5):
        ...
        self.upsamples = nn.Sequential(UpsampleBlock(num_channels, 2), UpsampleBlock(num_channels, 2))  # *2*2
